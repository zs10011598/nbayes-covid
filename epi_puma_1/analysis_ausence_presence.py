...
def nbayes_epi_puma_v1(target, covariables, lim_inf_training, lim_sup_training, 
		  lim_inf_validation, lim_sup_validation, type_analysis=None, 
		  lim_inf_first=None, lim_sup_first=None):
	'''
		Description: This function makes a request to Epi-Puma API 1.0

		Args:
			- target: A list with some of the following variables
					  "COVID-19 CONFIRMADO", "COVID-19 NEGATIVO", 
					  "COVID-19 FALLECIDO".
			- covariables: A list with some of the following variables
						   "Demograficos", "Pobreza", "Movilidad", 
						   "Infraestructura-salud", "Vulnerabilidad",
						   "Worldclim",
